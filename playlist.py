...
LOGOS = {
    ...
    "carolinekwan": "https://static-cdn.jtvnw.net/jtv_user_pictures/fc00a270-348e-4f77-973b-1c32261e1a26-profile_image-150x150.png",
    ...
    "lychee": "https://static-cdn.jtvnw.net/jtv_user_pictures/bb7b82e9-853b-444c-aafe-f291956e699d-profile_image-150x150.png",
...
def main():
    # Formato brasileiro: DD/MM/AAAA HH:MM:SS (UTC)
    now = datetime.utcnow().strftime("%d/%m/%Y %H:%M:%S")
    lines = [f"#EXTM3U", f"# Gerado em {now} UTC"]
